# Project Plan: Scope: auth, dashboard, reporting.
...
- Scope: auth, dashboard, reporting.

## 3. Meeting-driven priorities
- Kickoff: deliver portal in 3 sprints.
...
|-------|------|-------|-----|
| Discovery | Scope: auth, dashboard, reporting. | Week 1 | Week 2 |
